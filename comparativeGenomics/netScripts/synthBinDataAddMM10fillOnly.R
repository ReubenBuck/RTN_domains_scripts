...
# not ready for mouse
dnase <- read.table("~/Documents/dna_turnover/workStationDesktop//RTN_domains/data/UCSCtracks/mm10/mm10_dnase1_cluster_lift.bed",
...
lads <- read.table("~/Documents/dna_turnover/workStationDesktop//RTN_domains/data/UCSCtracks/mm10/laminB1Lads", 
...
load("~/Documents/dna_turnover/workStationDesktop//RTN_domains/R_objects/rmskTables/mm10/mm10.RData")
...
recRate <- read.table("~/Documents/dna_turnover/workStationDesktop//RTN_domains/data/UCSCtracks/mm10/mm10_recombinationRate_lift.bed",
...
recHot <- read.table("~/Documents/dna_turnover/workStationDesktop//RTN_domains/data/UCSCtracks/mm10/mm10_recombHotSpot_lift.bed",
...
cpg <- read.table("Documents/dna_turnover/workStationDesktop//RTN_domains/data/UCSCtracks/mm10/cpgIslandExtUnmasked.txt",
...
save(synthBin.gr,file =  "~/Documents/dna_turnover/workStationDesktop//RTN_domains/R_objects/netsAnalysis/syntheticBinnedGenome/mm10.synthBin.genome.variable.fillOnly.RData")
