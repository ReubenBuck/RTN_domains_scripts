...
rep$repGroup[rep$repFamily == "L1ME" | rep$repFamily == "L1MD" | rep$repFamily == "L1MC" | rep$repFamily == "L1MB" | rep$repFamily == "L1MA"] <- "old_L1"
...
if(genome == "hg19"){
  ...
  rep$repGroup[rep$repFamily == "L1PB" | rep$repFamily == "L1PA" | rep$repFamily == "L1HS" ] <- "new_L1"
  ...
  rep$repGroup[rep$repFamily == "Lx" | rep$repFamily == "L1Md" | rep$repFamily == "L1_Mus" | rep$repFamily == "L1_Mur" | rep$repFamily == "L1_Mm" ] <- "new_L1"
